...
namespace WADNghi13A.Controllers
{
    public class PersonnelsController : Controller
    {
        ...
        public PersonnelsController(WADNghi13AContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Department,FirstName,FamilyName,Address,Dob,Gender,Position")] Personnel personnel)
        {
            if (id != personnel.Id)
            {
                return NotFound();
